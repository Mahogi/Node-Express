...
// import { ChocolateViewModel, ChocolateData, PartialChocolateBody } from '../chocolates/types';
...
// };
//
// const updateChocolate = async (id: string, chocolateData: PartialChocolateBody): Promise<ChocolateViewModel> => {
//   const mySqlConnection = await mysql.createConnection(config.db);
